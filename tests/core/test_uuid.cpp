...
TEST(UUID, FromStringInvalidReturnsNil) {
    EXPECT_EQ(UUID::from_string("not-a-uuid"), UUID::NIL);
    EXPECT_EQ(UUID::from_string(""), UUID::NIL);
    EXPECT_EQ(UUID::from_string("zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"), UUID::NIL);
}
