// helios-renderer/src/helios/forward_plus/passes/shadow_pass.h
//
// Shadow pass render graph node. Produces a cascade shadow map (Depth32F
// 2D-array texture) and computes cascade light-space matrices on the CPU.
#pragma once
