// helios-renderer/src/helios/forward_plus/passes/forward_pass.h
//
// Main Forward+ PBR rendering pass. Reads depth, shadow map, culled light
// indices, and IBL textures, then renders all meshes with full lighting into
// an HDR (RGBA16F) color attachment.
#pragma once
