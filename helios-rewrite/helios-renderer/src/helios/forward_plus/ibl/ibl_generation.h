// helios-renderer/src/helios/forward_plus/ibl/ibl_generation.h
//
// IBL (Image-Based Lighting) texture generation. All three stages (irradiance
// convolution, prefilter environment map, BRDF LUT) are one-shot compute
// dispatches triggered when a skybox environment map is loaded.
#pragma once
