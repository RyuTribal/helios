...
public:
    ...
    LoadBatch(const LoadBatch&) = delete;
    LoadBatch& operator=(const LoadBatch&) = delete;
    LoadBatch(LoadBatch&& other) noexcept;
    LoadBatch& operator=(LoadBatch&& other) noexcept;
