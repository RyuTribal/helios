...
public:
    ...
    /// While captured, warp the cursor back to the grab point each frame.
    /// Call this every frame during camera orbit to prevent cursor drift.
    void warp_cursor_to_grab();
