#include "graphics/HVESwapChain.hpp"
...
namespace hve {
    ...
    VkResult HVESwapChain::submitCommandBuffers(
    ...
    VkSurfaceFormatKHR HVESwapChain::chooseSwapSurfaceFormat(
    ...
    VkPresentModeKHR HVESwapChain::chooseSwapPresentMode(
